...
// case의 데이터 유형은 switch 식의 데아터 유형과 일치!
switch(fruit) {
  case 'apple':
    console.log('사과');
...
console.log('=== 삼항 연산자 ===');
grade = score < 0 || score > 100 ? console.log('유효한 점수가 아닙니다') : score >= 90 ? 'A' : (score >= 80) ? 'B' : (score >= 70) ? 'C' : (score > 60) ? 'D' : 'F'
