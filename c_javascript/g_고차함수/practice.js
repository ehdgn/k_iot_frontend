...
// 1번 문제
// 다음 배열을 조건에 따라 작성하고 실행 했을 때의 결과를 확인하시오.
...
function passingScores(scores) {
  ...
  const passingAvg = passing.reduce((acc, score) => acc + score) / passingCount;
...
console.log(filteredWords(words, 'ap'));