...
function SearchBox({handleSearch, inputRef, loading, query, reset, setQuery}: SearchBoxProps) {
  return (
    <div className='search-box'>
      <h4>상품 검색</h4>
      {/* 검색어 입력창 */}
      <input type="text" ref={inputRef} value={query} onChange={e => setQuery(e.target.value)} placeholder='검색어를 입력하세요' />
